...
import { View, Text, TextInput, TouchableOpacity, TouchableHighlight, StyleSheet, Modal, KeyboardAvoidingView, ScrollView, Alert, FlatList } from 'react-native';
...
export default class BookRequestScreen extends Component {
    ...
    addRequest = async (bookName, reasonToRequest) => {
        ...
        var books = await BookSearch.searchbook(bookName, 'AIzaSyCHSe2R7sEFOx5lq_O1rylWxLq81pRd1_g')
